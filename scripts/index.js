...
editPopup.addEventListener('click', closeByOverlayClick);
addPopup.addEventListener('click', closeByOverlayClick);
figurePopup.addEventListener('click', closeByOverlayClick);